...
router.get('/cewe/vietnam', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/Asupan/master/cecan/vietnam.json`))
...
router.get('/cewe/thailand', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/Asupan/master/cecan/thailand.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/china', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/Asupan/master/cecan/china.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/indonesia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/Asupan/master/cecan/indonesia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/korea', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/Asupan/master/cecan/korea.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/japan', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/Asupan/master/cecan/japan.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/malaysia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/Asupan/master/cecan/malaysia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/cecan', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/warga62/master/cecan.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/hijaber', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/warga62/master/hijaber.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/warga62/master/asupan.js`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/rikagusriani', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/warga62/master/asupan/rikagusriani.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/santuy', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/warga62/master/santuy.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/ukty', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/warga62/master/ukhty.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/bocil', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/warga62/master/bocil.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/asupan/ghea', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/warga62/master/geayubi.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/ass', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/ass.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/ahegao', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/ahegao.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/bdsm', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/bdsm.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/blowjob', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/blowjob.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/cuckold', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/cuckold.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/cum', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/cum.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/ero', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/ero.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/femdom', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/femdom.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/foot', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/foot.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/gangbang', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/gangbang.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/glasses', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/glasses.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/hentai', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/hentai.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/hentaigif', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/hnt_gifs.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/jahy', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/jahy.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/masturbation', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/masturbation.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/nsfwNeko', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/nsfwNeko.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/orgy', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/orgy.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/panties', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/panties.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/pussy', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/pussy.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/thighs', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/thighs.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/nsfw/yuri', async (req, res, next) => {
	...
	if (apikeyInput != 'Rimuru')  return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Animeseleraku/BgAL-Api/master/nsfw/yuri.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
